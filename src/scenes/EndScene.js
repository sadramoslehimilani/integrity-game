...
export class EndScene extends BaseScene {
     ...
     */
    setupBackground() {
        this.background = this.add.image(this.centerX, this.centerY, 'end-background');
    ...
    getLearningSummary() {
        ...
        const perfectAnswers = this.answers.filter(a => a.integrityPoints === 10).length;
        ...
        summary += '• It\'s important to tell the truth, even about small mistakes\n';
        summary += '• Being honest shows good character and integrity\n';
        summary += '• Making the right choice isn\'t always easy, but it\'s always worth it';
    ...
    shareResults() {
        ...
        const shareTitle = this.add.text(
            this.centerX, 
            this.centerY - 80, 
            'Share Your Results!', 
            {
        ...
        shareOverlay.add([
            overlayBg, sharePanel, shareTitle, shareText, 
            closeBtn.background, closeBtn.text
        ]);
