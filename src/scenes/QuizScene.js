...
export class QuizScene extends BaseScene {
     ...
     */
    setupBackground() {
        this.background = this.add.image(this.centerX, this.centerY, 'quiz-background');
        this.background.setDisplaySize(this.gameWidth, this.gameHeight);
        this.background.setTint(0x34495e); // Dark blue-gray tint
        
        // Add overlay for better readability
        this.overlay = this.add.rectangle(this.centerX, this.centerY, this.gameWidth, this.gameHeight, 0x2c3e50, 0.7);
    }
    ...
    setupQuizUI() {
        ...
        this.scenarioText = this.add.text(
            this.centerX - 50, 
            this.centerY - 80, 
            '', 
            {
        ...
        this.questions = [
            {
                ...
                scenario: 'During practice, Nico accidentally kicks the ball and it hits the referee\'s whistle, knocking it into the bushes. The referee doesn\'t notice and continues the game. What should Nico do?',
                choices: [
                    {
                        text: 'Tell the referee immediately what happened',
                        integrity: 10,
                        feedback: 'Excellent! Being honest right away shows great integrity.'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        integrity: 0,
                        feedback: 'This isn\'t the right choice. Honesty is always the best policy.'
                    }
                ]
            },
            {
                ...
                scenario: 'Carla saw what happened with the whistle. She asks Nico, "Are you going to tell the referee?" How should Nico respond?',
                choices: [
                    {
                        text: '"Yes, I should tell the truth about what happened."',
                        integrity: 10,
                        feedback: 'Perfect! Nico shows he understands the importance of honesty.'
                    },
                    {
                        text: '"Maybe... I\'m not sure what to do."',
                        integrity: 3,
                        feedback: 'It\'s okay to feel uncertain, but the right thing to do is be honest.'
                    },
                    {
            ...
            },
            {
                ...
                scenario: 'After Nico tells the truth, Coach Leo talks to the team about integrity. He asks, "Why is it important to be honest, even about small mistakes?"',
                choices: [
                    {
                    ...
                    },
                    {
                        ...
                        integrity: 5,
                        feedback: 'That\'s one reason, but the best reason is that honesty builds trust.'
                    },
                    {
                        text: '"I don\'t know"',
                        integrity: 2,
                        feedback: 'That\'s okay! The important thing is that honesty helps people trust us.'
                    }
                ]
            }
        ];
    ...
    showQuestion() {
        ...
        // Update progress
        this.progressText.setText(`Question ${this.currentQuestion + 1} of ${this.questions.length}`);
    ...
    showFeedback(feedbackText, callback) {
        ...
        const feedbackTextObj = this.add.text(
            this.centerX, 
            this.centerY - 20, 
            feedbackText, 
            {
        ...
        feedbackOverlay.add([
            overlayBg, feedbackPanel, feedbackTextObj, 
            continueBtn.background, continueBtn.text
        ]);
